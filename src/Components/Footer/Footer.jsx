        ...
        <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center'>
            <div>
                <div className='logoDiv'>
                    <h1 className='logo text-[25px] text-white pd-[1.5rem] '>
                        <strong>Job</strong>Search
                    </h1>
                </div>

                <p className='text-white opacity-70 leading-7'>
                    We always make out finder and companies find the best jobs and employers find the best candidates
                </p>
            </div>
            ...
            <div className='grid'>
                ...
                <div className='text-[18px] text-white'>
                    <small>jobfinder@gmail.com</small>
