...
import valentines from '../../Assets/parachute.png'
        ...
        <div className='mb-[4rem] mt-[6rem]'>
            ...
            <div className='grid gap-[10rem] grid-cols-3 items-center'>
                ...
                <div className='singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem] '>
                    ...
                    <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold '>
                        We believe in making better for everyone, even if just by a little bit.
                    </p>
                </div>
            ...
            <div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] rounded-[10px]">
                ...
                <button className='border-[2px] rounded-[10px] py-[4px] px-[50px] text-[18px] font-semibold text-blueColor hover:bg-white hover:text-blueColor border-blueColor'>
                    Get Started
                </button>
            </div>
        </div>
